package io.github.sdxqw.utils.font;
...
public final class CFontRenderer extends CFont {
    ...
    public void drawStringWithShadowScaled(String text, int givenX, int givenY, int color, double givenScale) {
        GL11.glPushMatrix();
        GL11.glTranslated(givenX, givenY, 0);
        GL11.glScaled(givenScale, givenScale, givenScale);
        drawStringWithShadow(text, 0, 0, color);
        GL11.glPopMatrix();
    }
